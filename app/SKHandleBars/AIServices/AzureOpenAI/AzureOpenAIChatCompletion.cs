...
using AzureOpenAICompletion = Microsoft.SemanticKernel.Connectors.AI.OpenAI.ChatCompletion.AzureOpenAIChatCompletion;

namespace Microsoft.SemanticKernel.Handlebars;

public class AzureOpenAIChatCompletion : AIService, IChatCompletion
{
    private readonly AzureOpenAICompletion azureChatCompletion;
    ...
    {
        this.azureChatCompletion = new AzureOpenAICompletion(
            deploymentName,
            endpoint,
            apiKey
        );
